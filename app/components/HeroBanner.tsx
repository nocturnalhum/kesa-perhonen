...
export default function HeroBanner() {
  ...
  return (
    ...
    >
      <div className='flex flex-col mx-auto gap-2 laptop:flex-row items-center justify-evenly'>
        <div className='relative w-full max-h-screen'>
          ...
          />
          <div className='absolute flex flex-col items-center justify-center w-full max-h-[80vh] inset-0 h-full laptop:mb-0 text-center'>
