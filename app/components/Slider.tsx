    ...
    <Container>
      ...
      >
        <CarouselContent>
          ...
          <CarouselItem>
            <h2 className='absolute w-full h-full font-medium flex flex-col items-start justify-center gap-3 pl-[10vw] sm:pl-[15vw] md:pl-[10vw]'>
              <span className='text-[4.5vw] sm:text-[4vw] md:text-[3vw] text-slate-400 '>
                Stock Up
              </span>
